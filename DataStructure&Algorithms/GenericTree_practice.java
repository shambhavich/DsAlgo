...
public class GenericTree_practice {
    ...
    //Find an element in GT - Method 1
    ...
    public static void kDown(TreeNode root,TreeNode blockNode,int time,List<List<Integer>> ans){
